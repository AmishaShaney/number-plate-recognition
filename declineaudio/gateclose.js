document.addEventListener('DOMContentLoaded', () => {
    ...
    const declinedSound = document.getElementById('declined-sound');

    if (!leftPanel || !rightPanel || !gate || !declinedContainer || !declinedSound) {
    ...
    // Show declined message and play sound after gates are fully closed
    setTimeout(() => {
        console.log("Showing declined message");
        declinedContainer.classList.add('show');
        declinedSound.play(); // Play the declined sound
